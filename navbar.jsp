	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<c:if test="${userobj.role eq 'user' }">
				<a href="#" class="btn btn-light mr-1" data-toggle=
					"modal" data-target="#exampleModal"><i class="fa-solid fa-user"></i>
					${sessionScope.userobj.name} </a>
				<a href="logout" class="btn btn-light"><i
					class="fa-solid fa-right-to-bracket"></i> Logout </a>
			</c:if>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
    ...
    <th>${sessionScope.userobj.name}</th>
</tr>
<tr>
    <th scope="row">Qualification</th>
    <th>${sessionScope.userobj.qualification}</th>
</tr>
<tr>
    <th scope="row">Email</th>
    <th>${sessionScope.userobj.email}</th>
</tr>
							</tbody>
						</table>
					</div>
